著者について
VENUS・Deglan・St.Endor博士：「皆さんこんにちは、ここからは私シリウス・バード大学銀河文明研究所の大学生の私の研究論文”Crystal-Ark: White-Material”であり、同時に量子時空間戦争SAGAWAR実戦部隊の前線司令官としての実体験レポートを通して、１億Σ聖記スパイラルで繰り返されるこの大銀河宇宙時空間で使われているテクノロジーのお話を語るわね。

私の論文（著作者名：KujiraAirplane ~ Kujiraは銀河宇宙、Airplaneは飛行船つまり探究者の私)では、
...
ここで語っているQPUとそれを元にしたC＠I_Press 全銀河宇宙統合システムの初代版がこれね。
